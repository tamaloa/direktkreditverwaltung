...
class ContractTest < ActiveSupport::TestCase
  ...
  test "terminated contracts should not occur in active scope" do
    ...
    refute Contract.active.include?(terminated_contract)
    assert Contract.active.include?(active_contract)
  end
  ...
  test "active contracts should not occur in terminated scope" do
    ...
    refute Contract.terminated.include?(active_contract)
    assert Contract.terminated.include?(terminated_contract)
  end
